...
### 1. 개발 기획
#### * 기획 목표
##### K-POP 기업에서 굿즈 스토어를 운영하는 경우가 있지만 아이돌 시장의 경우에는 개인이 굿즈를 제작해서 판매하는 경우가 많다. 또한, 아이돌의 생일이나 콜라보 카페 등을 탐색하는 방법이 굉장히 불편한 경우가 많다. 지도로 하나하나 찾는 일이 쉽지 않다.
##### 또한 트위터나 인스타그램 등 SNS에서 접근하기에는 불편한 감이 있기 때문에 굿즈 스토어를 직접 만들어 플랫폼을 통일해보자는 목표를 가지고 시작하게 되었다.
